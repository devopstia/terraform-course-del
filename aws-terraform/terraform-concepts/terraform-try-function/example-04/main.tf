...
resource "aws_instance" "example" {
  ...
  tags = merge(try(var.instance_configs["tags"], {}), {
    Name = format("%s-%s-%s-vm", try(var.instance_configs["tags"]["id"], ""), try(var.instance_configs["tags"]["environment"], ""), try(var.instance_configs["tags"]["project"], ""))
  })
}
