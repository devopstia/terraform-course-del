...
resource "aws_instance" "example" {
  ...
  tags = {
    ...
    # Name = format("vm-%02d", count.index + 0)
    # Name = format("vm-%02d", count.index + 2)
    # Name = format("vm-%02d", count.index + 12)
    # Name = format("vm-%02d", count.index + 1)
    # Name = format("vm-%03d", count.index + 1)
    # Name = format("vm-%04d", count.index + 1)
    # Name = format("vm-%01d", count.index + 1)
    # Name = format("vm-%0d", count.index + 1)
    # Name = format("vm-%0d", count.index + 0)
