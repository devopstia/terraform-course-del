...
#   name = "${var.control_plane_name}-aws-load-balancer-controller-iam-role"
...
#   tags = {
#     tag-key = "${data.aws_eks_cluster.example.id}-aws-load-balancer-controller-iam-role"
#   }
# }

# # https://raw.githubusercontent.com/kubernetes-sigs/aws-load-balancer-controller/main/docs/install/iam_policy.json
# resource "aws_iam_policy" "aws-load-balancer-controller-polcy" {
#   name        = "aws-load-balancer-controller-polcy"
#   path        = "/"
